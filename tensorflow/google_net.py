''' GoogleNet Model converted from Caffe to Tensorflow using the following:
- https://github.com/ethereon/caffe-tensorflow
- https://github.com/BVLC/caffe/tree/master/models/bvlc_googlenet

Converted model is modified to work with the changed Network class.
'''

from network import Network

class GoogleNet(Network):
    def __init__(self, inputs, num_classes, trainable=Network.ALL_TRAINABLE):
    ...
    def setup(self):
        ...
        (self.feed('inception_5b_1x1',
             ...
             .fc(self.num_classes, relu=False, name='loss3_classifier', initialize=True)
             .softmax(name='prob'))